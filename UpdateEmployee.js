...
export default function UpdateEmployee() {
  ...
  const [dob,setDob]=useState("");
    async function update(event){
        ...
        try{
            await axios.put("http://localhost:8089/api/v1/employee/edit/"+employeeid,{
                _id:_id,
    ...
    <div>
      ...
      <form className="bu" class="w3-text-blue w3-light-grey w3-margin" style={{padding:"40px"}}>
          ...
          <div class="w3-row w3-section">
            <div class="w3-rest">
              <i class="xxlarge fa fa-user" style={{width:"20px"}}></i>
              <input class="w3-border" name="designation" type="text" placeholder='Designation' value={desig}
                onChange={(event) =>
                  {
          ...
          <button class="w3-button w3-block w3-ripple w3-padding w3-blue" style={{marginBottom :"20px"}} onClick={update}>Update</button>
      </form>
      </div>
      </div>
        </body>
